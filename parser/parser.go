...
func (p *Parser) parseForAssign() *AssignmentStatement {
	stmt := &AssignmentStatement{
		NodeBase: NodeBase{Token: p.curTok},
	}
...
func (p *Parser) parseForStatement() *ForStatement {
	...
	fmt.Println("AFTER INIT:", p.curTok.Type, p.peekTok.Type)
